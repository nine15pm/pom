...
from cosyvoice2.matcha.models.components.flow_matching import BASECFM
from cosyvoice2.utils.common import set_all_random_seed
...
class ConditionalCFM(BASECFM):
    ...
    def forward_estimator(self, x, mask, mu, t, spks, cond, streaming=False):
        if not isinstance(self.estimator, torch.nn.Module):
            raise TypeError("estimator must be a torch.nn.Module in minimal PyTorch-only decoder build")
