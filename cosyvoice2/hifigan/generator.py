...
from cosyvoice2.transformer.convolution import CausalConv1d, CausalConv1dDownSample, CausalConv1dUpsample
from cosyvoice2.transformer.activation import Snake
from cosyvoice2.utils.common import get_padding
from cosyvoice2.utils.common import init_weights
...
class HiFTGenerator(nn.Module):
    ...
    def __init__(
        ...
        self.stft_window = torch.hann_window(istft_params["n_fft"], periodic=True, dtype=torch.float32)
